...
public class MentorshipRequestController {
    ...
    public ResponseEntity<Void> requestMentorship(MentorshipRequestDto mentorshipRequestDto) {
    ...
    public ResponseEntity<Void> rejectRequest(@PathVariable("id") @Min(1) long id, RejectionDto rejection) {
