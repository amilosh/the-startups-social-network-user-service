...
class EventServiceTest {
    ...
    @Test
    void testUserSkillsForEventWithUserSkillsDoNotContainAllRequiredSkills() {
    ...
    @Test
    void testUserSkillsForEventUserSkillsContainAllRequiredSkills() {
        when(skillMapper.toDtoList(user.getSkills()))
                .thenReturn(Arrays.asList(skillDto1, skillDto2));
    ...
    @Test
    void testUserSkillsForEventUserSkillsAreEmpty() {
        ...
        assertFalse(result,
                "User with no skills should not be able to create an event with required skills");
    }
}